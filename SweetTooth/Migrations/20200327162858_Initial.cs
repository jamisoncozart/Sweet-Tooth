    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SweetFlavorId = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FlavorId = table.Column<int>(nullable: false),
                    SweetId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SweetFlavor", x => x.SweetFlavorId);
                    table.ForeignKey(
                        name: "FK_SweetFlavor_Flavors_FlavorId",
                        column: x => x.FlavorId,
                        principalTable: "Flavors",
                        principalColumn: "FlavorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SweetFlavor_Sweets_SweetId",
                        column: x => x.SweetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SweetFlavor_FlavorId",
                table: "SweetFlavor",
                column: "FlavorId");

            migrationBuilder.CreateIndex(
                name: "IX_SweetFlavor_SweetId",
                table: "SweetFlavor",
                column: "SweetId");
